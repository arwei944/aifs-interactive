...
对于代码摘要工作流，一个有用的MCP服务器需要：遍历文件树，选择要读取的文件，合成摘要，然后返回。LLM推理发生在哪里？
...
- [MCP — Concepts: Sampling](https://.io/docs/concepts/sampling) — high-level overview of sampling
- [MCP — Client sampling spec 2025-11-25](https://.io/specification/2025-11-25/client/sampling) — canonical `sampling/createMessage` shape
- [MCP — GitHub SEP-1577](https://github.com//) — Spec Evolution Proposal for tools in sampling (experimental)
