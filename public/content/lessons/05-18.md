...
按用例挑选。使用XLM-R-base作为相同的默认设置，分类工作得很好。生成任务需要mT5或NLLB，这取决于翻译和开放生成。LLM风格的工作配对与Aya-23或克劳德使用明确的多语言提示。
...
”“python
从Transformer导入AutoTokenizer， 
进口火炬

tok = AutoTokenizer.from_pretrained（"joeddav/xlm-roberta-large-xnli"）
model =  .from_pretrained（"joeddav/xlm-roberta-large-xnli"）
