...
> ReLU 在负区域的梯度恒为 0，这意味着该区域的神经元永远不会更新权重，被称为「神经元死亡」。
...
> GELU 处处可微且在零点附近有非零梯度，使得梯度在深层网络中流动更顺畅，这对 Transformer 的训练稳定性至关重要。
...
> 当 |x| 很大时，Sigmoid 的梯度趋近于 0（饱和区），经过多层累乘后梯度几乎消失，导致深层网络难以训练。
:::
