...
## Build it
 ...
 Then calculates the cross-entropy loss per depth on the short synthetic sequence and counts the parameters by component printing. A toy vocabulary list containing 32 marks makes the numbers readable.
